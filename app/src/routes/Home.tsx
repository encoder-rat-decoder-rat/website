...
const Home: React.FC = () => {
  return (
    <>
      ...
      <p>Our debut project <strong><a href="/projects/gender-generator">Gender Generator</a></strong> premiered at the MIT CAST Unfolding AI Symposium.</p>
      <p>Current Project: <strong><a href="/orfelia">The Orfelia</a></strong></p>
      ...
      <p>ERDR is open for technical and creative consultating specializing in the intersection of design, technology, futures, and gender. Do you want to incorporate deep conversations into your company, school, or non-profit? We&#39;re here for you! Contact <a href="mailto:dylan@dylanbox.com">Dylan Box</a> and let&#39;s start talking.</p>
    </>
  )
}
